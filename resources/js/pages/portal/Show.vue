...
import { CalendarClock, CircleDashed, FileText, Mail, Phone } from 'lucide-vue-next';
...
<template>
    ...
    <div class="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(16,185,129,0.14),_transparent_28%),linear-gradient(180deg,_#f8fafc,_#eef2ff)] px-4 py-10 dark:bg-[radial-gradient(circle_at_top,_rgba(16,185,129,0.18),_transparent_28%),linear-gradient(180deg,_#020617,_#0f172a)]">
        <div class="mx-auto flex max-w-5xl flex-col gap-6">
            <div class="rounded-[2rem] border border-slate-200/80 bg-white/90 p-8 shadow-[0_30px_80px_-45px_rgba(15,23,42,0.35)] backdrop-blur dark:border-slate-800 dark:bg-slate-950/75">
                <p class="text-sm font-semibold tracking-[0.2em] text-emerald-600 uppercase dark:text-emerald-300">
                    {{ portal.workspace || 'CRM Lite' }}
                </p>
                <h1 class="mt-4 text-3xl font-semibold tracking-tight text-slate-950 dark:text-white">
                    {{ portal.client.name }}
                </h1>
                ...
                <div class="mt-6 flex flex-wrap gap-3">
                    <StatusBadge :status="null" :label="portal.client.status_label || 'Shared portal'" />
                    <span class="rounded-full bg-slate-100 px-4 py-2 text-sm font-medium text-slate-600 dark:bg-slate-800 dark:text-slate-300">
            ...
            <div class="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        <div class="crm-subtle-panel flex items-center gap-3">
                            <Mail class="size-5 text-emerald-600 dark:text-emerald-300" />
                            <div>
                        ...
                        <div class="crm-subtle-panel flex items-center gap-3">
                            <Phone class="size-5 text-sky-600 dark:text-sky-300" />
                            <div>
                        ...
                        <div class="crm-subtle-panel flex items-center gap-3">
                            <CalendarClock class="size-5 text-amber-600 dark:text-amber-300" />
                            <div>
                                <p class="text-sm text-slate-500 dark:text-slate-400">Next follow-up</p>
                                <p class="font-semibold text-slate-950 dark:text-white">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div v-if="portal.documents.length > 0" class="space-y-3">
                            <div
